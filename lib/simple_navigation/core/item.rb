module SimpleNavigation
  ...
  class Item
    ...
    def html_options
      ...
      html_classes = [@html_options[:class], self.selected_class, self.active_leaf_class]
      html_classes << autogenerated_item_class if self.autogenerate_item_classes?
      options[:class] = html_classes.flatten.compact.join(' ')
    ...
    # Returns true if the item's id should be added to the rendered output.
    def autogenerate_item_classes?
      SimpleNavigation.config.autogenerate_item_classes
    end

    # Returns the item's id which is added to the rendered output.
    def autogenerated_item_class
      SimpleNavigation.config.class_generator.call(key)
    end
